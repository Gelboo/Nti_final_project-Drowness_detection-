...
os.chdir('dataset_B_Eye_Images/Right/')
EyeState = os.listdir(".")
print(EyeState)
os.chdir('../..')
...
def prepare_X_Y(path):
    ...
    return x_y
x_y_data = prepare_X_Y('dataset_B_Eye_Images/Right/')
...
checkpointer = ModelCheckpoint(filepath='EyeStateRight.weights.best.hdf5', verbose=1,
                               save_best_only=True)
